...
class SiteData {
  ...
  getAboutPagePara() {
    return this.site.aboutPage;
  }
  getWorkPagePara() {
    return this.site.workPage;
  }
  getResumeLink() {
    return this.site.resume_link;
  }
  ...
  getFavoriteBooks() {
    return this.goodreads.favorites.GoodreadsResponse.reviews.review.slice(
      0,
      5
    );
  }
  ...
  getAllProjects() {
    return this.projects.sort((p1, p2) => p1.order - p2.order);
  }
